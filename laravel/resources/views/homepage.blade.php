...
<head>
  ...
  <!-- Fonts -->
  <link href="{{asset('assets/home/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
  <link href="{{asset('assets/home/css/animate.css')}}" rel="stylesheet" />
  <!-- Squad theme CSS -->
  <link href="{{asset('assets/home/css/style.css')}}" rel="stylesheet">
  <link href="{{asset('assets/home/color/default.css')}}" rel="stylesheet">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="/buyer_registration">Buyer</a></li>
              <li><a href="/seller_registration">Seller</a></li>
  ...
  <section id="intro" class="intro">
    ...
    <div class="slogan">
      <h2>WELCOME TO <span class="text_color">Buyer Seller Portal</span> </h2>
      <h4>Let's Start......</h4>
    </div>
  ...
  <section id="service" class="home-section text-center bg-gray">
    ...
    <div class="container">
      <div class="row">
        ...
        <div id="a">
          <div id="b">
            <h3 style="margin-top: 1px;">Buyer</h3>
            <p>Of many texting trends, a system known as microblogging has surfaced, which consists of a miniaturized blog, inspired mainly by people's tendency to jot down informal thoughts and post them online. They consist of websites like Twitter and its Chinese equivalent Weibo (微博). As of 2016, both of these websites were popular.</p>
            <button class="btn">Register as a Buyer</button>
          </div>
          <div id="c">
            <h3>Seller</h3>
            <p>Of many texting trends, a system known as microblogging has surfaced, which consists of a miniaturized blog, inspired mainly by people's tendency to jot down informal thoughts and post them online. They consist of websites like Twitter and its Chinese equivalent Weibo (微博). As of 2016, both of these websites were popular.</p>
            <button type="button" class="btn">Register as a Seller</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-12">
          ...
          <p>@Buyer seller. All rights reserved.</p>
          <div class="credits">
            <!--
            ...
            -->
            Designed by <a href="https://bootstrapmade.com/">Ceymox</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="{{asset('assets/home/js/jquery.scrollTo.js')}}"></script>
